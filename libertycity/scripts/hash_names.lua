...
local zone_names_lc = {
    ...
    ["ZSOHAN1"] = "South Bohan",
    ["ZSOHAN2"] = "South Bohan",
    ["Zacti"] = "Acter Industrial Park",
    ["Zacti1"] = "Acter Industrial Park",
    ["ZBOULE1"] = "Boulevard",
    ["ZBOULE2"] = "Boulevard",
    ["ZBOULE3"] = "Boulevard",
    ["ZBOULE4"] = "Boulevard",
    ["Zcgci1"] = "Castle Garden City",
    ["Zcgci2"] = "Castle Garden City",
    ["Zcgci3"] = "Castle Garden City",
    ["Zcgci4"] = "Castle Garden City",
    ["Zchisl1"] = "Charge Island",
    ["Zchisl2"] = "Charge Island",
    ["Zmdw1"] = "Middle Park West",
    ["Zmdw2"] = "Middle Park West",
    ["Zmdw3"] = "Middle Park West",
    ["Zvarh"] = "Varsity Heights",
    ["Zmidpa"] = "Middle Park",
    ["Znhol1"] = "North Holland",
    ["Znhol2"] = "North Holland",
    ["Zehol1"] = "East Holland",
    ["Zehol2"] = "East Holland",
    ["Znort1"] = "Northwood",
    ["Znort2"] = "Northwood",
    ...
    ["Znort4"] = "Northwood",
    ["Znort5"] = "Northwood",
    ["Zmeat"] = "The Meat Quarter",
    ["Zwestm"] = "Westminster",
    ["Zpurg1"] = "Purgatory",
    ["Zpurg2"] = "Purgatory",
    ["Zpurg3"] = "Purgatory",
    ["Zeast"] = "Easton",
    ["Zpres"] = "Presidents City",
    ["Zhat"] = "Hatton Gardens",
    ["Zlance"] = "Lancet",
    ["Zsuff1"] = "Suffolk",
    ["Zsuff2"] = "Suffolk",
    ...
    ["Zlowe1"] = "Lower Easton",
    ["Zlowe2"] = "Lower Easton",
    ["Zfisn"] = "Fishmarket North",
    ["Zfiss1"] = "Fishmarket South",
    ["Zfiss2"] = "Fishmarket South",
    ["Zfiss3"] = "Fishmarket South",
    ["Zfiss4"] = "Fishmarket South",
    ["Zfiss5"] = "Fishmarket South",
    ["Zexc1"] = "The Exchange",
    ["Zexc2"] = "The Exchange",
    ["Zexc3"] = "The Exchange",
    ["Zexc4"] = "The Exchange",
    ["Zcgar1"] = "Castle Gardens",
    ["Zcgar2"] = "Castle Gardens",
    ["Zcgar3"] = "Castle Gardens",
    ["Zcgar4"] = "Castle Gardens",
    ["Zcois1"] = "Colony Island",
    ["Zcois4"] = "Colony Island",
    ["Zcois5"] = "Colony Island",
    ["Zcois3"] = "Colony Island",
    ["Zcois8"] = "Colony Island",
    ["Zlanc1"] = "Lancaster",
    ["Zlanc2"] = "Lancaster",
    ["Zmide"] = "Middle Park East",
    ["Zleft1"] = "Leftwood",
    ["Zleft2"] = "Leftwood",
    ["ZEHOK9"] = "East Hook",
    ["ZEHOK8"] = "East Hook",
    ...
    ["ZINDUS1"] = "Industrial",
    ["ZINDUS3"] = "Industrial",
    ["ZHap1"] = "Happiness Island",
    ["ZHap2"] = "Happiness Island",
    ["ZHap3"] = "Happiness Island",
    ["Zald1"] = "Alderney City",
    ["Zald2"] = "Alderney City",
    ["Zald3"] = "Alderney City",
    ["Zald4"] = "Alderney City",
    ...
    ["Ztudo1"] = "Tudor",
    ["Ztri"] = "The Triangle",
    ["ZRHIL3"] = "Rotterdam Hill",
    ["ZRHIL7"] = "Rotterdam Hill",
    ["ZRHIL8"] = "Rotterdam Hill",
    ["ZRHIL9"] = "Rotterdam Hill",
    ["ZRHIL5"] = "Rotterdam Hill",
    ["ZRHIL4"] = "Rotterdam Hill",
    ["ZRHIL6"] = "Rotterdam Hill",
    ["ZRHIL2"] = "Rotterdam Hill",
    ["ZRHIL1"] = "Rotterdam Hill",
    ["ZRHIL10"] = "Rotterdam Hill",
    ["ZRHIL11"] = "Rotterdam Hill",
    ["ZRHIL12"] = "Rotterdam Hill",
    ["ZRHIL13"] = "Rotterdam Hill",
    ["ZRHIL15"] = "Rotterdam Hill",
    ["ZRHIL16"] = "Rotterdam Hill",
    ["ZRHIL14"] = "Rotterdam Hill",
    ["Zwest2"] = "Westdyke",
    ["Zwest1"] = "Westdyke",
    ["ZDOWNT"] = "Downtown",
    ["ZFIEPR1"] = "Firefly Projects",
    ["ZFIEPR2"] = "Firefly Projects",
    ["ZFIEPR3"] = "Firefly Projects",
    ["ZFIEPR4"] = "Firefly Projects",
    ["ZFIEPR5"] = "Firefly Projects",
    ["ZFIEPR6"] = "Firefly Projects",
    ["ZOUTLO"] = "Outlook",
    ["ZHOVEB1"] = "Hove Beach",
    ["ZHOVEB2"] = "Hove Beach",
    ["ZHOVEB3"] = "Hove Beach",
    ["ZESTCT2"] = "East Island City",
    ["ZESTCT9"] = "East Island City",
    ["ZESTCT5"] = "East Island City",
    ["ZESTCT6"] = "East Island City",
    ["ZESTCT7"] = "East Island City",
    ["ZESTCT8"] = "East Island City",
    ["ZESTCT1"] = "East Island City",
    ["ZESTCT3"] = "East Island City",
    ["ZESTCT4"] = "East Island City",
    ["ZMPARK1"] = "Meadows Park",
    ["ZMPARK2"] = "Meadows Park",
    ["ZMPARK3"] = "Meadows Park",
    ["ZMPARK4"] = "Meadows Park",
    ["ZCERV1"] = "Cerveza Heights",
    ["ZCERV2"] = "Cerveza Heights",
    ["ZCERV3"] = "Cerveza Heights",
    ["ZCERV4"] = "Cerveza Heights",
    ["ZSHTLER"] = "Schottler",
    ["ZBECCT1"] = "Beechwood City",
    ["ZBECCT2"] = "Beechwood City",
    ["ZBECCT3"] = "Beechwood City",
    ["ZBECCT4"] = "Beechwood City",
    ["ZBECCT5"] = "Beechwood City",
    ["ZAIRPT1"] = "Francis International Airport",
    ["ZAIRPT2"] = "Francis International Airport",
    ["ZAIRPT3"] = "Francis International Airport",
    ["ZSLOPES"] = "South Slopes",
    ["ZNRDNS1"] = "Northern Gardens",
    ["ZNRDNS2"] = "Northern Gardens",
    ["ZNRDNS3"] = "Northern Gardens",
    ["ZNRDNS4"] = "Northern Gardens",
    ["ZNRDNS5"] = "Northern Gardens",
    ["ZNRDNS6"] = "Northern Gardens",
    ["ZNRDNS7"] = "Northern Gardens",
    ["ZCHASE1"] = "Chase Point",
    ["ZCHASE2"] = "Chase Point",
    ["ZMHILLS"] = "Meadow Hills",
    ["ZFRIS1"] = "Firefly Island",
    ["ZFRIS2"] = "Firefly Island",
    ["Zberc"] = "Berchem",
    ["Zberc1"] = "Berchem",
    ["ZWILIS1"] = "Willis",
    ["ZAIRU0"] = "Francis International Airport",
    ["ZAIRU2"] = "Francis International Airport",
    ["ZAIRU4"] = "Francis International Airport",
    ["ZAIRU5"] = "Francis International Airport",
    ["ZAIRU3"] = "Francis International Airport",
    ["ZAIRU6"] = "Francis International Airport",
    ["ZAIRU7"] = "Francis International Airport",
    ["ZAIRU8"] = "Francis International Airport",
    ["ZAIRU9"] = "Francis International Airport",
    ["ZAIRU1"] = "Francis International Airport",
    ["ZBEG1"] = "Beachgate",
    ["ZBEG2"] =  "Beachgate",
    ["ZBRI1"] = "Broker Bridge",
    ["ZBRI2"] = "Broker Bridge",
    ...
    ["ZBOO21"] = "Booth Tunnel",
    ["ZBOO23"] = "Booth Tunnel",
    ["ZPENN1"] = "Alderney State Correctional Facility",
    ["ZPENN2"] = "Alderney State Correctional Facility",
    ["ZPENN3"] = "Alderney State Correctional Facility",
    ["ZPENN5"] = "Alderney State Correctional Facility",
    ["ZPENN4"] = "Alderney State Correctional Facility",
    ["ZLEAP"] = "Leaper's Bridge",
    ["ZFORT"] = "Fortside",
}
...
CreateThread(function()
    ...
    for k,v in pairs(zone_names_lc) do
        AddTextEntry(k, v)
    end
end)